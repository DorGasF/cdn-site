...
var TwitterWidget = function TwitterWidget(node, options) {
  ...
  var TwitterWidget = {
    data: {
      ...
      user: {
        name: 'ZapTank',
        screen_name: 'NãoTemosTwitter',
        profile_image_url: 'https://cdn.jsdelivr.net/gh/DorGasF/cdn-zaptank/personagem.png',
      },
    },
    oninit: function(vnode) {
      var ctrl = this.ctrl(vnode);
...
var FacebookWidget = function FacebookWidget(node, options) {
  ...
  var FacebookWidget = {
    data: {
      ...
      user: {
        name: 'ZapTank',
        username: 'zaptankoficial',
        picture: {
          data: {
            url: 'https://cdn.jsdelivr.net/gh/DorGasF/cdn-zaptank/personagem.png',
          }
        }
      }
    },
